...
import com.example.devz.DevzApplication;
import com.example.devz.models.Developer;
import com.example.devz.models.Skill;
import com.example.devz.repositories.DeveloperRepository;
import com.example.devz.repositories.SkillRepository;
...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Skill sql = new Skill("SQL", budgie);
        Skill spring = new Skill("Spring", budgie);
